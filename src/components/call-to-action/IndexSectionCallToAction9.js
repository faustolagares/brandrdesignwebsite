  ...
  <div className="container px-4 mx-auto">
    <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-16 sm:py-28 rounded-4xl bg-orange-800 overflow-hidden">
      ...
      <div className="relative text-center">
        <span className="block text-2xl sm:text-3xl md:text-4xl font-semibold text-orange-400 mb-6">Ready to collaborate?</span>
        ...
        <a className="relative group inline-block w-full sm:w-auto py-4 px-6 text-orange-900 hover:text-white font-semibold bg-white rounded-md overflow-hidden transition duration-300" href="#">
