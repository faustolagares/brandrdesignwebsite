...
export default function IndexSectionStats12() {
    return (
        <React.Fragment>
            <>
                <section className="relative py-20 md:py-32 overflow-hidden">
  <img className="absolute top-0 right-0 md:mt-10 -mr-20 md:-mr-0" src="saturn-assets/images/stats/star-circle.svg" alt />
  <img className="absolute bottom-0 left-0" src="saturn-assets/images/stats/left-blue-light.png" alt />
      ...
      <div className="flex flex-wrap -mx-4">
        <div className="relative w-full md:w-1/3 px-4 pb-9 md:pb-0 mb-12 lg:mb-0">
          ...
          <div className="text-center">
            <span className="block text-5xl lg:text-7xl font-bold text-gray-900 mb-5">300+</span>
        ...
        <div className="relative w-full md:w-1/3 px-4 pb-9 md:pb-0 mb-12 lg:mb-0">
          ...
          <div className="md:hidden absolute bottom-0 left-1/2 h-px w-40 bg-gray-200 transform -translate-x-1/2" />
          <div className="text-center">
            <span className="block text-5xl lg:text-7xl font-bold text-gray-900 mb-5">85</span>
            <span className="text-xl text-gray-500">WEB TEMPLATE</span>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-4">
          <div className="text-center">
            <span className="block text-5xl lg:text-7xl font-bold text-gray-900 mb-5">215</span>
