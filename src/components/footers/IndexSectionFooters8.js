...
export default function IndexSectionFooters8() {
  ...
  <img className="absolute bottom-0 left-1/2 transform -translate-x-1/2" src="saturn-assets/images/footers/orange-light-bottom.png" alt />
        ...
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
            <a className="inline-block" href="#">
              <img className="h-15" src="saturn-assets/logos/logo-saturn-dark.svg" alt />
            </a>
          </div>
      ...
      <div className="flex flex-wrap -mx-4 mb-18">
        <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
          <div className="xs:max-w-xs">
            ...
            <form action>
              <label className="block mb-1.5 text-sm font-semibold text-gray-900" htmlFor>Email</label>
