      ...
      <div className="flex flex-wrap -mx-4 mb-18 items-center">
        ...
        <div className="w-full lg:w-1/3 xl:w-1/2 px-4">
          <div className="max-w-sm lg:ml-auto">
            <p className="text-lg text-gray-500">We are a team of 20+ who are passionate about making the world a better place.</p>
          </div>
        </div>
      </div>
      <div className="flex flex-wrap -mx-4">
        <div className="w-full xl:w-1/2 px-4 mb-8 xl:mb-0">
          <div className="relative h-100 md:h-125">
            <img className="block h-full w-full rounded-3xl object-cover" src="saturn-assets/images/features/blue-photo.png" alt />
            <div className="absolute top-0 left-0 h-full w-full p-8 md:p-12">
              <div className="flex flex-col items-start justify-between h-full max-w-sm">
                <div>
                  <span className="block mb-3 text-sm text-yellow-800 font-semibold uppercase">Ready for future</span>
          ...
          <div className="flex flex-wrap h-full -mx-4">
            <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
              <div className="flex flex-col h-full">
                <a className="relative block h-full mb-7 pt-8 px-8 pb-5 rounded-3xl bg-green-50 hover:bg-green-100 transition duration-200" href="#">
                  ...
                  <img className="absolute bottom-0 right-0 m-5" src="saturn-assets/images/features/arrow.svg" alt />
                </a>
                <a className="relative block h-full pt-8 px-8 pb-5 rounded-3xl bg-red-50 hover:bg-red-100 transition duration-200" href="#">
                  <div className="flex flex-col h-full justify-between max-w-sm pr-16">
            ...
            <div className="w-full md:w-1/2 px-4">
              <a className="relative block h-full pt-8 px-8 pb-5 rounded-3xl bg-orange-50 hover:bg-orange-100 transition duration-200" href="#">
